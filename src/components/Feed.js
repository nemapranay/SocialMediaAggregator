...
export default function Feed() {
  ...
  const currentUsersFeedtemp = feeds?.filter(el => {
    return currentUser.followedInfluencersId.includes(el.influencerId);
  });
    ...
    <View style={{flex: 1}}>
            ...
            <TouchableOpacity
              ...
              <View
                style={{
                  ...
                  margin: 5,
                  borderRadius: 10,
                  borderColor: isSelected ? THEME_COLOR : 'black',
                }}>
      ...
      {currentUsersFeed?.length > 0 ? (
        ...
        <View style={{marginVertical: 10}}>
          <ThemedText>
            {'No feeds found, please follow more influencers to see data'}
          </ThemedText>
        </View>
      )}
    </View>
